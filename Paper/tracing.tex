...
are generated separately before the call, in order to allow generation of line number information 
...
% #########################################################################################
\section{Examples}
A study of a large model computation with  the MIT general circulation model 
is under way.  
