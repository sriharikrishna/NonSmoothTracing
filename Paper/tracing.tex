...
\end{minipage}
\begin{minipage}[t]{.48\linewidth}
\lstinputlisting[basicstyle=,frame=single,language=Fortran,firstline=3,firstnumber=3]{Code/OneMinuteExample/head.prepped.pre.f90}
\end{minipage}
...
\hspace*{.3cm}\lstinline{head.prepped.pre.xb.x2w.w2f.post.f}\\[1ex] 
...
\lstinputlisting[frame=single]{Code/OneMinuteExample/head.prepped.pre.xb.x2w.w2f.post.f90}
\caption{Transformed code from input shown in \reffig{fig:OneMinute} (left)}\label{fig:OneMinuteTransformed}
\end{figure}
\begin{figure}
...
{\scriptsize \verbatiminput{tracingAlgOpts.ftxt}}
...
\lstinputlisting[basicstyle=,frame=single,language=Fortran,firstline=3,firstnumber=3]{Code/ControlFlow/head.prepped.pre.f90}
\end{minipage}
\begin{minipage}{.48\linewidth}
\lstinputlisting[basicstyle=,frame=single,language=Fortran,firstline=3,firstnumber=3]{Code/ArrayIndex/head.prepped.pre.f90}
\end{minipage}
...
\lstinputlisting[basicstyle=,frame=single,language=Fortran,firstline=3,firstnumber=3]{Code/CallStack/head.prepped.pre.f90}
\end{minipage}
}
