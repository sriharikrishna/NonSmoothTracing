...
{\tiny
\verbatimfile{OneMinuteStatusOutput.txt}
}
The resulting fortran output is contained in a file called \lstinline{head.prepped.xb.x2w.w2f.pp.f} and 
its contents is shown in \reffig{fig:OneMinuteTransformed}  
\begin{figure}
...
outlined in the OpenAD Manual \cite{userManual}. 
