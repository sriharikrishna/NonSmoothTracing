...
\end{minipage}
\caption{An example for tracing subroutine calls}\label{fig:CallStack} 
\end{wrapfigure} 
respective XML elements provides some means of navigating the 
...
The website also contains instructions how to contribute to the \openad\ source.
